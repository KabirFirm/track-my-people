...
import 'package:track_my_people/permission_status.dart';
import 'package:track_my_people/service_enabled.dart';
    ...
    if (service is AndroidServiceInstance) {
      if (await service.isForegroundService()) {
        ...
        service.setForegroundNotificationInfo(
          ...
          content: "${_location} at ${DateTime.now()}",
        );
      }
    }
          ...
          children: [
            StreamBuilder<Map<String, dynamic>?>(
              ...
              builder: (context, snapshot) {
                ...
                LocationData? locationData = data["location"];
